...
export const mockAdminBookings: AdminBooking[] = [
  { id: 'bk_a_018', user_id: 'u_admin', student_id: 's_001', facility_id: 'f_ish1', facility_name: 'Indoor Sports Hall', start_time: ahead(8), end_time: ahead(9), status: 'confirmed', purpose: 'Block 57 futsal practice', attendee_count: 10, qr_token: 'a7f3c1d2e9b8' },
  ...
  { id: 'bk_a_015', user_id: 'u_admin', student_id: 's_002', facility_id: 'f_soccer', facility_name: 'Street Soccer Court', start_time: ahead(98), end_time: ahead(99), status: 'confirmed', purpose: 'Morning rally', attendee_count: 2, qr_token: 'd1c2b3a4e5f6' },
  { id: 'bk_a_014', user_id: 'u_admin', student_id: 's_003', facility_id: 'f_ish1', facility_name: 'Indoor Sports Hall', start_time: ahead(12), end_time: ahead(13), status: 'confirmed', purpose: 'Badminton casual', attendee_count: 4, qr_token: 'e1f2a3b4c5d6' },
  ...
  { id: 'bk_a_012', user_id: 'u_admin', student_id: 's_005', facility_id: 'f_pool', facility_name: 'Swimming Pool', start_time: ahead(48), end_time: ahead(49), status: 'confirmed', purpose: 'Morning laps', attendee_count: 2, qr_token: 'g1h2i3j4k5l6' },
  ...
  { id: 'bk_a_009', user_id: 'u_admin', student_id: 's_012', facility_id: 'f_ish1', facility_name: 'Indoor Sports Hall', start_time: ahead(96), end_time: ahead(97), status: 'confirmed', purpose: 'Basketball pickup', attendee_count: 8, qr_token: 'j1k2l3m4n5o6' },
  ...
  { id: 'bk_a_007', user_id: 'u_admin', student_id: 's_016', facility_id: 'f_basketball', facility_name: 'Basketball Court', start_time: ahead(24), end_time: ahead(25), status: 'confirmed', purpose: 'Casual hoops', attendee_count: 2, qr_token: 'l1m2n3o4p5q6' },
  // Past bookings
  { id: 'bk_a_006', user_id: 'u_admin', student_id: 's_001', facility_id: 'f_ish1', facility_name: 'Indoor Sports Hall', start_time: ago(48), end_time: ago(47), status: 'checked_in', purpose: 'Futsal practice', attendee_count: 10, qr_token: 'm1n2o3p4q5r6' },
